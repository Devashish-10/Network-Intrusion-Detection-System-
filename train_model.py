...
# Paths to the training and testing of the datasets
...
# Dropping the 'Unnamed: 0' and 'id' columns if they exist by default
...
# Feature extraction using correlation analysis
...
# Filtering the datasets based on high correlation features
...
# Apply PCA for dimensionality reduction and make robust model
pca = PCA(n_components=0.95)  # retain 95% of variance
X_train_pca = pca.fit_transform(X_train)
X_test_pca = pca.transform(X_test)

# Defining a function to evaluate models performance
...
# Hyperparameter tuning for SVM with RBF kernel as RBF gave us best results can also try with Linear and Poly Kernels
param_grid = {
    'C': [0.1, 1],
...
# Visualizing the PCA explained variance ratio
